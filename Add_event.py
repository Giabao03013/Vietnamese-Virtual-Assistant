...
# #
# # nlu_interpreter = load_interpreter("models/20211219-080543.tar.gz")
# # print(nlu_interpreter.pipeline)
#
# import speech_recognition as sr
# import time
# def callback(recorgnier, audio):
#     print(recorgnier.recognize_google(audio,language='vi-VI'))
# recognier = sr.Recognizer
# mic = sr.Microphone
# with mic as source:
#     recognier.adjust_for_ambient_noise(source)
# stop_listen  = recognier.listen_in_background(recognier,callback)
# stop_listen(wait_for_stop=True)
from tkinter import *
import time
import datetime
import pyttsx3
